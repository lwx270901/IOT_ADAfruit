...
public class MQTTHelper {
    ...
    final String[] subscriptionTopic =
            new String[]{"izayazuna/feeds/button",
                    "izayazuna/feeds/error", "izayazuna/feeds/hummidity", "izayazuna/feeds/temperature"};


    final String username = "izayazuna";
    final String password = "aio_TyOi92YHzHMImC9BOpX4cB4VbOGa";
